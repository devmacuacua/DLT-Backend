...
public class AgywPrevQueries {
	...
	public static final String TOTAL_NEWLY_ENROLLED_AGYW_AND_SERVICES= ""
			+ "select  count(nui) total\n"
			+ "from\n"
			+ "(\n"
			+ "	select distinct pr.name provincia,\n"
			+ "		dt.name distrito,\n"
	...
	public static final String NEWLY_ENROLLED_AGYW_AND_SERVICES_SUMMARY= ""
			...
			+ "	from agyw_prev_mview v\n"
			+ "	left join\n"
			+ "	(	select beneficiary_id, service_id, sub_service_id, max(intervention_date) max_data_servico\n"
			+ "		from agyw_prev_mview\n"
	...
	public static final String TOTAL_VULNERABILITIES_AND_SERVICES=""
			+ "select  count(nui) total\n"
			+ "from\n"
			+ "(\n"
			+ "	select distinct pr.name provincia,\n"
			...
			+ "	from\n"
			+ "	(\n"
			+ "		select beneficiary_id,max(intervention_date)\n"
			+ "		from agyw_prev_mview\n"
			+ "		where intervention_date between :startDate and :endDate		\n"
			+ "		and intervention_status = 1\n"
	...
	public static final String VULNERABILITIES_AND_SERVICES_SUMMARY=""
			...
			+ "	) servico_ano\n"
			+ "	inner join \n"
			+ "	(	select *,max(intervention_date) max_data_servico\n"
			+ "		from agyw_prev_mview\n"
			+ "		where intervention_status=1\n"
			+ "		-- and provincia_id=2\n"
			+ "		group by beneficiary_id,service_id,sub_service_id\n"
